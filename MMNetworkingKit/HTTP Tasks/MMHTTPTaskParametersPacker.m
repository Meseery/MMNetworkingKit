...
@implementation MMHTTPTaskParametersPacker
{
    MMHTTPTask *_netTask;
}
...
- (NSDictionary *)parametersFromRequestObject:(id<MMHTTPTaskRequestObject>)requestObject
{
...
- (NSDictionary *)parametersFromDictionary:(NSDictionary *)dictionary inRequestObject:(id<MMHTTPTaskRequestObject>)requestObject
{
    NSString *separator = [self separatorFromRequestObject:requestObject];
    NSMutableDictionary *parameters = [NSMutableDictionary new];
...
- (id)parameterValueFromValue:(id)value inRequestObject:(id<MMHTTPTaskRequestObject>)requestObject
{
    ...
    if ([value conformsToProtocol:@protocol(MMHTTPTaskRequestObject)]) {
...
- (NSString *)separatorFromRequestObject:(id<MMHTTPTaskRequestObject>)requestObject
{
    NSString *separator = MMHTTPTaskRequestObjectDefaultSeparator;
...
- (BOOL)shouldPackPropertyWithAttributes:(NSArray *)attributes
{
    ...
    return ![attributes containsObject:@"R"] && [attributes[0] rangeOfString:NSStringFromProtocol(@protocol(MMIgnore))].location == NSNotFound;
}
